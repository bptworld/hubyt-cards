...
def render(options=None):
    ...
    draw.rectangle((0, 0, 63, 8), fill=(10, 18, 28))
    draw_sharp_text(image, (1, -3), "GITHUB", (145, 180, 255), bold)
    draw_sharp_text(image, (1, 8), name, (245, 250, 255), bold)
    draw_sharp_text(image, (1, 16), tag, (80, 220, 170), font)
    aw = draw.textbbox((0, 0), age, font=font)[2]
    draw_sharp_text(image, (63 - aw, 24), age, (150, 170, 185), font)
