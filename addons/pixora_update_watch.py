...
def render(options=None):
    ...
    if app_new:
        ...
        draw_sharp_text(image, (63 - w, y - 1), text, (245, 250, 255), bold)
        y += 9
    ...
    if card_delta > 0:
        ...
        text = f"+{card_delta}"
        w = draw.textbbox((0, 0), text, font=bold)[2]
        draw_sharp_text(image, (63 - w, y - 1), text, (255, 210, 80), bold)
        y += 9

    if app_new and card_delta > 0:
        _draw_center(image, draw, "BOTH READY", 0, 63, 24, (150, 170, 185), font)
    elif app_new:
        _draw_center(image, draw, "NEW RELEASE", 0, 63, 22, (150, 170, 185), font)
    else:
        _draw_center(image, draw, "NEW CARDS", 0, 63, 22, (150, 170, 185), font)
