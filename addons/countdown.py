...
def render(options=None):
    ...
    draw_sharp_text(image, ((64 - hw) // 2, -3), event_name, (24, 182, 163), header_font)
    draw.line((0, 8, 63, 8), fill=(15, 50, 50))
    ...
    if days is None:
        ...
        draw_sharp_text(image, ((64 - (tb[2] - tb[0])) // 2, 13), "SET DATE", (140, 140, 140), small_font)
    elif days <= 0:
        msg = "TODAY!" if days == 0 else "PAST!"
        tb  = draw.textbbox((0, 0), msg, font=big_font)
        draw_sharp_text(image, ((64 - (tb[2] - tb[0])) // 2, 9 + (14 - (tb[3] - tb[1])) // 2), msg, (80, 230, 140), big_font)
    else:
        num_str = str(days)
        ...
        draw_sharp_text(image, ((64 - (lb[2] - lb[0])) // 2, 20), label, (100, 180, 255), small_font)
